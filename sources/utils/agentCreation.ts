...
export function buildPrivateAgentBuilderImage(draft: ChatBuilderDraft): AgentImage {
    ...
    return {
        ...
        responsibilities: [
            ...
            `Read ${AGENT_BUILDER_PRIMARY_KNOWLEDGE_BASE} before creating any genome to ensure hub format compliance`,
        ],
        protocol: [
            ...
            'Always include messaging and behavior blocks in the final spec',
        ],
        capabilities: [
            'single-agent-design',
            'draft-sync',
        ...
        validation: {
            smokeTest: {
                ...
                healthChecks: [
                    ...
                    `Can read ${AGENT_BUILDER_PRIMARY_KNOWLEDGE_BASE} for hub format compliance`,
                ],
            },
        },
        meta: {
