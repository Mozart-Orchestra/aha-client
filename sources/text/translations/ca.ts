...
export const ca: TranslationStructure = {
    ...
    welcome: {
        ...
        restoreRequiredMessage: 'Aquest compte ja te dades. Introdueix la clau de restauracio.',
        restoreRecoveryNotReadyTitle: 'El material de recuperacio encara no esta llest',
        restoreRecoveryNotReadyMessage: 'Aquest compte de Google esta vinculat a un compte existent, pero el material de recuperacio encara no esta llest al servidor. Fes servir una clau de restauracio existent o obre "Afegeix un dispositiu nou" en un altre dispositiu connectat.',
        restoreSecretMismatchTitle: 'La clau d aquest dispositiu no coincideix amb el compte',
        restoreSecretMismatchMessage: 'Aquest compte de Google esta vinculat a un compte existent, pero aquest navegador guarda una clau local diferent. Introdueix la clau correcta o afegeix aquesta maquina des d un altre dispositiu connectat.',
        restoreKeyPlaceholder: 'XXXXX-XXXXX-XXXXX-...',
        restoreSubmit: 'Restaurar',
        enterRestoreKeyFirst: 'Introdueix primer la clau',
        copyRestoreCommand: 'Copia l\'ordre de restauracio',
        restoreCommandNeedsKeyMessage: 'Primer introdueix la teva clau real de restauracio. Aquesta pagina no la pot inventar ni recuperar per tu.',
        restoreCommandCopiedMessage: 'Ordre de restauracio copiada. Substitueix el marcador per la teva clau de restauracio i executa-la.',
        ...
        loggedInDeviceHelpSecretMismatch: 'Aquest dispositiu ara mateix guarda una clau local diferent, aixi que no pot recuperar automaticament el compte existent. Fes servir la clau original o afegeix aquesta maquina des d un altre dispositiu connectat.',
