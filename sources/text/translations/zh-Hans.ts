...
export const zhHans: TranslationStructure = {
    ...
    settings: {
        ...
        archivedMachines: '已归档设备',
        showAllArchivedMachines: ({ count }: { count: number }) => `显示全部已归档设备 (${count})`,
        showLessArchivedMachines: '显示更少已归档设备',
        features: '功能',
        social: '社交',
        account: '账户',
    ...
    sessionInfo: {
        ...
        restoreSessionSubtitle: '将此会话恢复到工作区',
        metadata: '元数据',
        host: '主机',
        path: '路径',
    ...
    home: {
        ...
        onboarding: {
            title: '登录成功！',
            subtitle: '接下来，连接你的第一台机器。',
            step1Title: '账户已创建',
            step1Subtitle: '登录成功',
            step2Title: '连接机器',
            step2Subtitle: '在任意机器上运行以下命令即可关联',
            step2Hint: '在终端中运行此命令，机器会自动出现在这里。',
            step3Title: '创建团队',
            step3Subtitle: '建立你的第一个 AI Agent 团队',
            commandCopiedTitle: '已复制！',
            commandCopiedMessage: '在终端中粘贴此命令以连接机器。',
        },
        gettingStarted: '快速上手',
        docsTitle: '新手入门指南',
        ...
        addDeviceTitle: '加入新设备',
        addDeviceSubtitle: '复制此命令，在任意机器上关联到当前服务器和账户',
        addDeviceHint: '在任意机器终端粘贴此命令。它会先固定当前服务器，再加入你的账户。',
        joinCommandExpiresIn: ({ time }: { time: string }) => `加入命令将在 ${time} 后过期`,
        joinCommandExpired: '加入命令已过期，请刷新生成新的命令。',
        exploreSection: '发现',
    ...
    settingsAccount: {
        ...
        professionalModeSubtitle: '在您的账户范围内显示 agent 的详细配置、hooks、MCP 服务与 spec 镜像。',
        professionalModeLocked: '请在账户设置中开启专业模式，以查看详细的 agent 配置与运行时内部信息。',
        profile: '个人资料',
        name: '姓名',
        github: 'GitHub',
        ...
        logoutConfirm: '您确定要登出吗？之后可能需要另一台已登录设备才能再次把这台机器加入进来。',
    },
    ...
    welcome: {
        ...
        otpSentTo: ({ email }: { email: string }) => `验证码已发送至 ${email}`,
        verifyCode: '验证',
        resendCode: '重新发送',
        resendIn: ({ seconds }: { seconds: number }) => `${seconds}s 后重新发送`,
        changeEmail: '更换邮箱',
        restoreRequired: '账户已存在',
        restoreRequiredMessage: '此账户已有数据。请在另一台已登录设备上打开“加入新设备”，然后在当前机器运行那边生成的加入命令。',
        restoreRecoveryNotReadyTitle: '恢复材料尚未就绪',
        restoreRecoveryNotReadyMessage: '这个 Google 账号已关联到现有账户，但服务器端恢复材料尚未就绪。请在另一台已登录设备上打开“加入新设备”，并在当前机器运行真实的加入命令。',
        googleCallbackFailedTitle: 'Google 登录失败',
        googleCallbackFailedMessage: ({ reason }: { reason: string }) => `Google 登录没有完成。${reason}`,
        googleSignInFailedFallback: 'Google 登录失败，请重试。',
        haveAnotherLoggedInDevice: '我有另一台已登录设备',
        restoreWhyTitle: '我该怎么继续？',
        loggedInDeviceHelp: '当前页面无法生成真实的 join code。请在另一台已登录设备打开“加入新设备”，再把那边生成的真实加入命令复制到当前机器运行。',
        loggedInDeviceHelpRecoveryNotReady: '这不是 Google 登录失败，而是该账户的恢复材料还没准备好。最快路径是在另一台已登录设备打开“加入新设备”，把真实加入命令复制到当前机器运行。',
        switchGoogleAccount: '切换 Google 账号',
    ...
    machine: {
        ...
        archivedNotice: '此设备已归档',
        archivedHelp: '恢复后才能再次用于新会话或团队启动。',
        daemon: '守护进程',
        status: '状态',
        daemonLikelyAlive: '可能运行中',
        daemonStopped: '已停止',
        stopDaemon: '停止守护进程',
        stopDaemonTitle: '停止守护进程？',
        stopDaemonConfirm: '停止后，在您重新在这台电脑上启动守护进程之前，将无法在此设备上创建新会话。当前会话会继续运行。',
        stopDaemonFailed: '停止守护进程失败，它可能并未运行。',
        ...
        statusArchived: '已归档',
        archiveMachine: '归档设备',
        archiveMachineConfirm: '要归档此设备吗？归档后它会从普通设备选择器中隐藏，直到恢复。',
        archiveMachineHelp: '将此设备从常规启动流程中隐藏，但保留其记录。',
        archiveMachineSuccess: '设备已归档。',
        archiveMachineFailed: '归档设备失败。',
        restoreMachine: '恢复设备',
        restoreMachineConfirm: '将这台已归档设备恢复到工作区中？',
        restoreMachineHelp: '让这台设备重新出现在启动器中。',
        restoreMachineSuccess: '设备已恢复。',
        restoreMachineFailed: '恢复设备失败。',
        deleteMachine: '删除设备',
        deleteMachineConfirm: '永久删除这台设备吗？这会从您的账户中移除它的保存记录。',
        deleteMachineHelp: '永久移除这条离线设备记录。',
        deleteMachineDisabledActive: '请先停止守护进程，或等待这台设备离线后再删除。',
        deleteMachineSuccess: '设备已删除。',
        deleteMachineFailed: '删除设备失败。',
        archiveMachineDisabledActive: '请先停止守护进程，或等待这台设备离线后再归档。',
        renameMachine: '重命名设备',
        renamePrompt: '给这台设备起一个自定义名称。留空则使用默认主机名。',
        renamePlaceholder: '输入设备名称',
        renameSuccess: '设备重命名成功。',
        renameFailed: '设备重命名失败。',
        customPathPlaceholder: '输入自定义路径',
        createDirectoryTitle: '创建目录？',
        createDirectoryConfirm: ({ directory }: { directory: string }) => `目录 '${directory}' 不存在。要创建它吗？`,
        startSessionFailed: '启动会话失败。请确认目标设备上的守护进程仍在运行。',
        activeSessions: ({ count }: { count: number }) => `活跃会话 (${count})`,
        previousSessions: '历史会话（最多显示最近 5 个）',
        machineGroup: '设备',
        host: '主机',
        machineId: '设备 ID',
        username: '用户名',
    ...
    agents: {
        ...
        newCorps: '运行军团',
        buildCorpsTitle: '配置军团',
        buildCorpsAddRole: '添加角色',
        buildCorpsEmptyHint: '添加角色开始配置军团',
        buildCorpsStart: '运行军团',
        buildCorpsDefaultName: '我的军团',
        buildCorpsSave: '保存模板',
        buildCorpsSavedTitle: '军团已保存',
        buildCorpsSavedMessage: '军团模板已保存到你的资料库，可以稍后继续运行。',
        buildCorpsSaveFailed: '保存军团模板失败。',
        buildCorpsSaveNoAuth: '请先登录后再保存军团模板。',
        buildCorpsRunFailed: '运行军团失败。',
        useGlobalMachine: '使用默认机器',
        agentName: 'Agent 名称',
        agentNamePlaceholder: '例如：我的构建 Agent',
        agentRuntime: '运行时',
        agentRuntimeManualHint: '手动模式下，这会直接写入最终 genome 的 runtime。',
        agentRuntimeChatHint: ({ builderName }: { builderName: string }) =>
            `Chat 模式下，这会启动 ${builderName}，并让最终 genome 默认对齐到同一 runtime。`,
        agentGenome: '基因（可选）',
        ...
        suggestions: '改进建议',
        actionKeep: '保留',
        actionGuardrails: '保留并加护栏',
        actionMutate: '变异',
        actionDiscard: '丢弃',
        evolutionControls: '进化控制',
        evolutionTarget: '进化目标',
        signInToEvolve: '登录后才能管理进化',
        signInToEvolveHint: '手动 verdict、进化、fork 和回滚都需要已登录账户。',
        noEvolutionTarget: '当前页面没有可操作的关联 genome image。',
        userVerdictTitle: '用户结论',
        userVerdictHint: '先记录人工判断，再把它 materialize 到 image 的反馈汇总里。',
        verdictScoreLabel: '评分',
        verdictActionLabel: '动作',
        verdictNotesLabel: '说明',
        verdictNotesPlaceholder: '哪里做得好、哪里失败、下一步应该怎么处理？',
        verdictNotesRequired: '提交前请填写 verdict 说明。',
        submitVerdict: '提交结论',
        userVerdictSaved: '结论已保存，反馈也已 materialize。',
        userVerdictFailed: '保存结论失败。',
        manualEvolveTitle: '手动进化',
        manualEvolveHint: '这里会把一条 learning note 追加进 image，并创建一个新版本。',
        manualEvolvePlaceholder: '描述应该带入下一版本的经验、改动或学习。',
        evolveNoteRequired: '创建新版本前请先填写进化说明。',
        createEvolvedVersion: '创建新版本',
        manualEvolveSuccess: '已根据手动进化说明创建新版本。',
        manualEvolveFailed: '创建新版本失败。',
        forkTitle: 'Fork Image',
        forkNamespaceLabel: 'Fork Namespace',
        forkNameLabel: 'Fork Name',
        forkFieldsRequired: 'fork namespace 和 fork name 都必填。',
        forkCreate: '创建 Fork',
        forkSuccess: 'Fork 创建成功。',
        forkFailed: '创建 Fork 失败。',
        versionHistoryTitle: '版本历史',
        noVersionHistory: '暂时还没有可用的发布版本历史。',
        currentVersion: '当前版本',
        rollbackAction: '回滚',
        rollbackSuccess: ({ version }: { version: number }) => `已基于 v${version} 创建新的头版本，完成回滚。`,
        rollbackFailed: '回滚失败。',
        rollbackSourceMissing: '无法加载你选择的源版本。',
        evidenceTitle: 'Trial 证据',
        evidenceLoading: '正在加载 trials 和 verdicts...',
        noEvidenceYet: '还没有 trial 证据',
        noEvidenceHint: '提交一次用户 verdict，或者从 live session 给它打分，证据链就会开始建立。',
        trialLabel: ({ version }: { version: number }) => `Trial · v${version}`,
        sessionLabel: '会话',
        noVerdictsForTrial: '这个 trial 还没有记录 verdict。',
        runStandalone: '独立运行',
        joinTeam: '加入团队',
        ...
        chatIntroTitle: '官方 Builder 对话',
        chatIntroBody: '这里启动的是官方 builder lineage，而不是页面内的临时私有 agent。它会先读自带的 builder 文档，再把可编辑草稿和可保存 spec 一起同步回这个页面。',
        chatBriefLabel: '创建简介',
        chatBriefPlaceholder: '例如：我需要一个礼貌的 SaaS 账单支持 Agent。',
        chatBriefHint: '先写任务、对象和成功标准即可，不用一次写很长。',
        launchPrivateBuilderTitle: '启动官方 Builder',
        launchPrivateBuilderBody: 'Claude 会启动 @official/agent-builder，Codex 会启动 @official/agent-builder-codex。创建时会优先保存 builder 回传的 spec，而不是重建右侧缩略草稿。',
        chatRunningTitle: 'Builder 对话已启动',
        chatRunningBody: '继续在这里细化需求。右侧表单仍会同步更新；一旦 builder 发回 spec sync，创建动作会直接保存那份 payload。',
        chatSpecStatusTitle: 'Builder Spec 同步状态',
        chatSpecPendingBody: ({ builderName }: { builderName: string }) =>
            `还没有可直接保存的 builder spec。${builderName} 当前只同步了可编辑草稿投影。`,
        chatSpecCompatibilityBody: ({ runtime }: { runtime: string }) =>
            `Builder 已经同步出一份可保存的 ${runtime} spec，但仍缺少部分 canonical agent.json block。`,
        chatSpecReadyBody: ({ runtime }: { runtime: string }) =>
            `Builder 已经同步出一份 canonical ${runtime} agent.json。创建动作会直接保存这份 payload。`,
        chatSpecIdentity: 'Canonical 身份',
    ...
    teams: {
        ...
        restoreTeam: '恢复团队',
        restoreTeamConfirm: '要恢复这个已归档团队，并将其已归档会话重新带回工作区吗？',
        restoreAction: '恢复',
        restoreTeamSuccess: ({ restoredSessions }: { restoredSessions: number }) => `团队已恢复，共恢复 ${restoredSessions} 个会话。`,
        restoreTeamFailed: '恢复团队失败，请重试。',
