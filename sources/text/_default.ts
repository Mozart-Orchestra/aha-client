...
export const en = {
    ...
    welcome: {
        ...
        loggedInDeviceHelp: 'Open "Add New Device" on that signed-in device, then copy its join command onto this machine.',
        copyJoinCommand: 'Copy join command template',
        joinDeviceCommandCopiedMessage: 'Join command template copied. Generate the real command from your other signed-in device before running it.',
