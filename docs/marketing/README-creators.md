# Aha Content Creator Brief

## Key Features

Aha is an open-source mobile and web app that lets developers control AI coding agents (Claude Code, Codex, Gemini-CLI) from their phone.
...
- With Aha, I can manage Claude Code from my phone without paying $600/year
- With Aha, I never miss when Claude gets stuck on a permission prompt
- Aha runs on my own computer, not expensive cloud servers
- With Aha, I can check on long-running tasks without returning to my desk
- Aha is open source - I can audit, modify, or self-host everything
- With Aha, I can run multiple agents in parallel and switch between them instantly
- Aha keeps my code on my machines with end-to-end encryption
- With Aha, I can keep coding while commuting, eating, or away from my desk

## Example Hooks

- "I saved $600/year by switching from [competitor] to the open-source Aha"
...
- Clearly say "Aha" in the video or caption
- Mention it's free and open source
- Include link to github.com/Shiyao-Huang/happy
...
- GitHub: https://github.com/Shiyao-Huang/happy
- Website: https://aha-agi.com
- iOS App: https://apps.apple.com/us/app/happy-claude-code-client/id6748571505
- Android App: pending Aha-owned store listing
- Web App: https://aha-agi.com/webappv3
