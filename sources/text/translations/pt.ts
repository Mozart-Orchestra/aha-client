...
export const pt: TranslationStructure = {
    ...
    welcome: {
        ...
        restoreRequiredMessage: 'Esta conta ja tem dados. Insira sua chave de restauracao.',
        restoreRecoveryNotReadyTitle: 'O material de recuperacao ainda nao esta pronto',
        restoreRecoveryNotReadyMessage: 'Esta conta do Google esta vinculada a uma conta existente, mas o material de recuperacao ainda nao esta pronto no servidor. Use uma chave de restauracao existente ou abra "Adicionar novo dispositivo" em outro dispositivo conectado.',
        restoreSecretMismatchTitle: 'A chave deste dispositivo nao corresponde a conta',
        restoreSecretMismatchMessage: 'Esta conta do Google esta vinculada a uma conta existente, mas este navegador guarda outra chave local. Digite a chave correta ou adicione esta maquina a partir de outro dispositivo conectado.',
        restoreKeyPlaceholder: 'XXXXX-XXXXX-XXXXX-...',
        restoreSubmit: 'Restaurar',
        enterRestoreKeyFirst: 'Digite a chave primeiro',
        copyRestoreCommand: 'Copiar comando de restauracao',
        restoreCommandNeedsKeyMessage: 'Primeiro digite sua chave real de restauracao. Esta pagina nao pode inventa-la nem recupera-la para voce.',
        restoreCommandCopiedMessage: 'Comando de restauracao copiado. Substitua o marcador pela sua chave de restauracao e execute.',
        ...
        loggedInDeviceHelpSecretMismatch: 'Este dispositivo esta guardando outra chave local agora, entao nao consegue recuperar automaticamente a conta existente. Use a chave original ou adicione esta maquina a partir de outro dispositivo conectado.',
