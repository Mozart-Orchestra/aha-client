...
export const ru: TranslationStructure = {
    ...
    home: {
        ...
        addDeviceSubtitle: 'Скопируйте команду для подключения любой машины к вашему аккаунту',
        addDeviceHint: 'Вставьте в терминал на любой машине для мгновенного подключения.',
