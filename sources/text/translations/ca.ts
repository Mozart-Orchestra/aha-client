...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        archivedMachines: 'Màquines arxivades',
        showAllArchivedMachines: ({ count }: { count: number }) => `Mostra totes les arxivades (${count})`,
        showLessArchivedMachines: 'Mostra menys màquines arxivades',
        features: 'Funcions',
        social: 'Social',
        account: 'Compte',
    ...
    home: {
        ...
        onboarding: {
            title: 'Ja hi ets!',
            subtitle: 'Connecta la teva primera maquina.',
            step1Title: 'Compte creat',
            step1Subtitle: 'Inici de sessio correcte',
            step2Title: 'Connectar una maquina',
            step2Subtitle: 'Executa aquesta comanda a qualsevol maquina',
            step2Hint: 'Executa-ho al terminal. La maquina apareixera aqui automaticament.',
            step3Title: 'Crear un equip',
            step3Subtitle: 'Configura el teu primer equip d\'agents IA',
            commandCopiedTitle: 'Copiat!',
            commandCopiedMessage: 'Enganxa aquesta comanda al terminal per connectar una maquina.',
        },
        ...
        addDeviceTitle: 'Afegir nou dispositiu',
        addDeviceSubtitle: 'Copia aquesta comanda per vincular qualsevol maquina a aquest servidor i compte',
        addDeviceHint: 'Enganxa-ho en un terminal de qualsevol maquina. Primer fixa el servidor actual i despres uneix el teu compte.',
        joinCommandExpiresIn: ({ time }: { time: string }) => `La comanda d'unio caduca en ${time}`,
        joinCommandExpired: 'La comanda d\'unio ha caducat. Actualitza per generar-ne una de nova.',
    ...
    settingsAccount: {
        ...
        professionalMode: 'Mode professional',
        professionalModeSubtitle: 'Mostra la configuració detallada dels agents, hooks, servidors MCP i miralls de spec a tot el compte.',
        professionalModeLocked: 'Activa el mode professional a la configuració del compte per veure la configuració detallada dels agents i els detalls interns del runtime.',
        profile: 'Perfil',
        name: 'Nom',
        github: 'GitHub',
        ...
        logoutConfirm: 'Estas segur que vols tancar la sessio? Despres potser necessitaras un altre dispositiu connectat per tornar a afegir aquesta maquina.',
    },
    ...
    welcome: {
        ...
        otpSentTo: ({ email }: { email: string }) => `Codi enviat a ${email}`,
        verifyCode: 'Verifica',
        resendCode: 'Reenvia el codi',
        resendIn: ({ seconds }: { seconds: number }) => `Reenvia en ${seconds}s`,
        changeEmail: 'Canvia email',
        restoreRequired: 'El compte ja existeix',
        restoreRequiredMessage: 'Aquest compte ja te dades. Obre "Afegeix un dispositiu nou" en un altre dispositiu connectat i executa aqui l ordre d unio.',
        restoreRecoveryNotReadyTitle: 'El material de recuperacio encara no esta llest',
        restoreRecoveryNotReadyMessage: 'Aquest compte de Google esta vinculat a un compte existent, pero el material de recuperacio encara no esta llest al servidor. Obre "Afegeix un dispositiu nou" en un altre dispositiu connectat i executa aqui l ordre real d unio.',
        googleCallbackFailedTitle: 'Ha fallat l inici de sessio amb Google',
        googleCallbackFailedMessage: ({ reason }: { reason: string }) => `No s ha pogut completar l inici de sessio amb Google. ${reason}`,
        googleSignInFailedFallback: 'Ha fallat l inici de sessio amb Google. Torna-ho a provar.',
        haveAnotherLoggedInDevice: 'Tinc un altre dispositiu connectat',
        restoreWhyTitle: 'Com continuo?',
        loggedInDeviceHelp: 'Aquesta pagina no pot generar un codi d\'unio real. Obre "Afegeix un dispositiu nou" en un altre dispositiu connectat i copia des d\'alla l\'ordre real.',
        loggedInDeviceHelpRecoveryNotReady: 'Aixo no es un error de login de Google. El material de recuperacio d aquest compte encara no esta llest, aixi que la via mes rapida es obrir "Afegeix un dispositiu nou" en un altre dispositiu connectat i executar aqui l ordre real.',
        switchGoogleAccount: 'Canvia de compte de Google',
    ...
    machine: {
        ...
        archivedNotice: 'Aquesta màquina està arxivada',
        archivedHelp: 'Restaura-la abans d\'usar-la per a noves sessions o llançaments d\'equips.',
        daemon: 'Dimoni',
        status: 'Estat',
        daemonLikelyAlive: 'probablement actiu',
        daemonStopped: 'aturat',
        stopDaemon: 'Atura el dimoni',
        stopDaemonTitle: 'Aturar el dimoni?',
        stopDaemonConfirm: 'No podràs crear noves sessions en aquesta màquina fins que reiniciïs el dimoni a l\'ordinador. Les sessions actuals continuaran vives.',
        stopDaemonFailed: 'No s\'ha pogut aturar el dimoni. Potser no està en execució.',
        ...
        lifecycleStatus: 'Disponibilitat',
        statusAvailable: 'disponible',
        statusArchived: 'arxivada',
        archiveMachine: 'Arxiva la màquina',
        archiveMachineConfirm: 'Arxivar aquesta màquina? Desapareixerà dels selectors normals fins que la restauris.',
        archiveMachineHelp: 'Amaga aquesta màquina dels fluxos normals sense esborrar-ne el registre.',
        archiveMachineSuccess: 'Màquina arxivada.',
        archiveMachineFailed: 'No s\'ha pogut arxivar la màquina.',
        restoreMachine: 'Restaura la màquina',
        restoreMachineConfirm: 'Restaurar aquesta màquina arxivada a l\'espai de treball?',
        restoreMachineHelp: 'Torna a fer visible aquesta màquina als llançadors.',
        restoreMachineSuccess: 'Màquina restaurada.',
        restoreMachineFailed: 'No s\'ha pogut restaurar la màquina.',
        deleteMachine: 'Elimina la màquina',
        deleteMachineConfirm: 'Eliminar aquesta màquina permanentment? Això treurà el registre desat del teu compte.',
        deleteMachineHelp: 'Elimina permanentment aquest registre de màquina fora de línia.',
        deleteMachineDisabledActive: 'Atura el dimoni o espera que aquesta màquina estigui fora de línia abans d\'eliminar-la.',
        deleteMachineSuccess: 'Màquina eliminada.',
        deleteMachineFailed: 'No s\'ha pogut eliminar la màquina.',
        archiveMachineDisabledActive: 'Atura el dimoni o espera que aquesta màquina estigui fora de línia abans d\'arxivar-la.',
        renameMachine: 'Canvia el nom de la màquina',
        renamePrompt: 'Dona un nom personalitzat a aquesta màquina. Deixa-ho buit per usar el nom d\'host per defecte.',
        renamePlaceholder: 'Introdueix el nom de la màquina',
        renameSuccess: 'S\'ha canviat el nom de la màquina correctament.',
        renameFailed: 'No s\'ha pogut canviar el nom de la màquina.',
        customPathPlaceholder: 'Introdueix un camí personalitzat',
        createDirectoryTitle: 'Crear directori?',
        createDirectoryConfirm: ({ directory }: { directory: string }) => `El directori '${directory}' no existeix. Vols crear-lo?`,
        startSessionFailed: 'No s\'ha pogut iniciar la sessió. Assegura\'t que el dimoni continua actiu a la màquina de destí.',
        activeSessions: ({ count }: { count: number }) => `Sessions actives (${count})`,
        previousSessions: 'Sessions anteriors (fins a les 5 més recents)',
    ...
    agents: {
        ...
        newCorps: 'Nou cos',
        buildCorpsTitle: 'Construeix el teu cos',
        buildCorpsAddRole: 'Afegir rol',
        buildCorpsEmptyHint: 'Afegeix rols per començar a construir el teu cos',
        buildCorpsStart: 'Iniciar cos',
