...
export const es: TranslationStructure = {
    ...
    welcome: {
        ...
        loggedInDeviceHelp: 'Abre "Agregar nuevo dispositivo" en ese dispositivo conectado y copia aqui su comando de union.',
        copyJoinCommand: 'Copiar plantilla del comando de union',
        joinDeviceCommandCopiedMessage: 'Plantilla del comando de union copiada. Genera el comando real desde tu otro dispositivo conectado antes de ejecutarlo.',
