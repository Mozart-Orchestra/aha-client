...
export const pt: TranslationStructure = {
    ...
    welcome: {
        ...
        loggedInDeviceHelp: 'Abra "Adicionar novo dispositivo" nesse dispositivo conectado e copie o comando de entrada para esta maquina.',
        copyJoinCommand: 'Copiar modelo do comando de entrada',
        joinDeviceCommandCopiedMessage: 'Modelo do comando de entrada copiado. Gere o comando real no outro dispositivo conectado antes de executar.',
