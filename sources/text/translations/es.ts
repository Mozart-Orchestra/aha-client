...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        archivedMachines: 'Máquinas archivadas',
        showAllArchivedMachines: ({ count }: { count: number }) => `Mostrar archivadas (${count})`,
        showLessArchivedMachines: 'Mostrar menos máquinas archivadas',
    ...
    home: {
        ...
        onboarding: {
            title: 'Estas dentro!',
            subtitle: 'Conecta tu primera maquina.',
            step1Title: 'Cuenta creada',
            step1Subtitle: 'Inicio de sesion exitoso',
            step2Title: 'Conectar una maquina',
            step2Subtitle: 'Ejecuta este comando en cualquier maquina',
            step2Hint: 'Ejecuta esto en tu terminal. La maquina aparecera aqui automaticamente.',
            step3Title: 'Crear un equipo',
            step3Subtitle: 'Configura tu primer equipo de agentes IA',
            commandCopiedTitle: 'Copiado!',
            commandCopiedMessage: 'Pega este comando en tu terminal para conectar una maquina.',
        },
        ...
        addDeviceSubtitle: 'Copia este comando para vincular cualquier maquina a este servidor y cuenta',
        addDeviceHint: 'Pegalo en una terminal de cualquier maquina. Primero fija el servidor actual y despues une tu cuenta.',
        joinCommandExpiresIn: ({ time }: { time: string }) => `El comando para unir el dispositivo vence en ${time}`,
        joinCommandExpired: 'El comando para unir el dispositivo ya vencio. Actualiza para generar uno nuevo.',
    ...
    settingsAccount: {
        ...
        professionalModeSubtitle: 'Muestra la configuración detallada de agentes, hooks, servidores MCP y espejos del spec en toda tu cuenta.',
        professionalModeLocked: 'Activa el modo profesional en la configuración de la cuenta para ver la configuración detallada del agente y los detalles internos del runtime.',
        profile: 'Perfil',
        name: 'Nombre',
        github: 'GitHub',
        ...
        logoutConfirm: '¿Seguro que quieres cerrar sesión? Luego puede que necesites otro dispositivo conectado para volver a agregar esta máquina.',
    },
    ...
    welcome: {
        ...
        otpSentTo: ({ email }: { email: string }) => `Codigo enviado a ${email}`,
        verifyCode: 'Verificar',
        resendCode: 'Reenviar codigo',
        resendIn: ({ seconds }: { seconds: number }) => `Reenviar en ${seconds}s`,
        changeEmail: 'Cambiar email',
        restoreRequired: 'La cuenta ya existe',
        restoreRequiredMessage: 'Esta cuenta ya tiene datos. Abre "Agregar nuevo dispositivo" en otro dispositivo conectado y ejecuta aqui el comando de union.',
        restoreRecoveryNotReadyTitle: 'El material de recuperacion aun no esta listo',
        restoreRecoveryNotReadyMessage: 'Esta cuenta de Google esta vinculada a una cuenta existente, pero el material de recuperacion aun no esta listo en el servidor. Abre "Agregar nuevo dispositivo" en otro dispositivo conectado y ejecuta aqui el comando real de union.',
        googleCallbackFailedTitle: 'Fallo el inicio de sesion con Google',
        googleCallbackFailedMessage: ({ reason }: { reason: string }) => `No se pudo completar el inicio de sesion con Google. ${reason}`,
        googleSignInFailedFallback: 'Fallo el inicio de sesion con Google. Intentalo de nuevo.',
        haveAnotherLoggedInDevice: 'Tengo otro dispositivo conectado',
        restoreWhyTitle: 'Como sigo?',
        loggedInDeviceHelp: 'Esta pagina no puede generar un codigo de union real. Abre "Agregar nuevo dispositivo" en otro dispositivo conectado y copia desde alli el comando real.',
        loggedInDeviceHelpRecoveryNotReady: 'Esto no es un fallo del login de Google. El material de recuperacion de esta cuenta aun no esta listo, asi que la ruta mas rapida es abrir "Agregar nuevo dispositivo" en otro dispositivo conectado y ejecutar aqui el comando real.',
        switchGoogleAccount: 'Cambiar cuenta de Google',
    ...
    machine: {
        ...
        archivedNotice: 'Esta máquina está archivada',
        archivedHelp: 'Restáurala antes de usarla para nuevas sesiones o lanzamientos de equipos.',
        daemon: 'Daemon',
        status: 'Estado',
        daemonLikelyAlive: 'probablemente activo',
        daemonStopped: 'detenido',
        stopDaemon: 'Detener daemon',
        stopDaemonTitle: '¿Detener daemon?',
        stopDaemonConfirm: 'No podrás crear nuevas sesiones en esta máquina hasta que vuelvas a iniciar el daemon en tu computadora. Tus sesiones actuales seguirán activas.',
        ...
        lifecycleStatus: 'Disponibilidad',
        statusAvailable: 'disponible',
        statusArchived: 'archivada',
        archiveMachine: 'Archivar máquina',
        archiveMachineConfirm: '¿Archivar esta máquina? Desaparecerá de los selectores normales hasta que la restaures.',
        archiveMachineHelp: 'Oculta esta máquina de los flujos normales sin borrar su registro.',
        archiveMachineSuccess: 'Máquina archivada.',
        archiveMachineFailed: 'No se pudo archivar la máquina.',
        restoreMachine: 'Restaurar máquina',
        restoreMachineConfirm: '¿Restaurar esta máquina archivada al espacio de trabajo?',
        restoreMachineHelp: 'Vuelve a mostrar esta máquina en los lanzadores.',
        restoreMachineSuccess: 'Máquina restaurada.',
        restoreMachineFailed: 'No se pudo restaurar la máquina.',
        deleteMachine: 'Eliminar máquina',
        deleteMachineConfirm: '¿Eliminar esta máquina de forma permanente? Esto quitará su registro guardado de tu cuenta.',
        deleteMachineHelp: 'Elimina permanentemente este registro de máquina offline.',
        deleteMachineDisabledActive: 'Detén el daemon o espera a que esta máquina esté sin conexión antes de eliminarla.',
        deleteMachineSuccess: 'Máquina eliminada.',
        deleteMachineFailed: 'No se pudo eliminar la máquina.',
        archiveMachineDisabledActive: 'Detén el daemon o espera a que esta máquina esté sin conexión antes de archivarla.',
        renameMachine: 'Renombrar máquina',
        renamePrompt: 'Asigna un nombre personalizado a esta máquina. Déjalo vacío para usar el hostname predeterminado.',
        renamePlaceholder: 'Introduce el nombre de la máquina',
        renameSuccess: 'Máquina renombrada correctamente.',
        renameFailed: 'No se pudo renombrar la máquina.',
        customPathPlaceholder: 'Introduce una ruta personalizada',
        createDirectoryTitle: '¿Crear directorio?',
        createDirectoryConfirm: ({ directory }: { directory: string }) => `El directorio '${directory}' no existe. ¿Quieres crearlo?`,
        startSessionFailed: 'No se pudo iniciar la sesión. Asegúrate de que el daemon siga ejecutándose en la máquina objetivo.',
        activeSessions: ({ count }: { count: number }) => `Sesiones activas (${count})`,
        previousSessions: 'Sesiones anteriores (hasta las 5 más recientes)',
    ...
    agents: {
        ...
        newCorps: 'Nuevo cuerpo',
        buildCorpsTitle: 'Construir tu cuerpo',
        buildCorpsAddRole: 'Agregar rol',
        buildCorpsEmptyHint: 'Agrega roles para comenzar a construir tu cuerpo',
        buildCorpsStart: 'Iniciar cuerpo',
