...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        archivedMachines: 'Máquinas arquivadas',
        showAllArchivedMachines: ({ count }: { count: number }) => `Mostrar todas as arquivadas (${count})`,
        showLessArchivedMachines: 'Mostrar menos máquinas arquivadas',
        features: 'Recursos',
        social: 'Social',
        account: 'Conta',
    ...
    newSession: {
        ...
        sessionTimeout: 'O agente ainda está iniciando. Abra a máquina para vê-lo quando aparecer, ou tente novamente em um momento.',
    ...
    sessionStarting: {
        ...
        connecting: 'Conectando à sua máquina…',
        bootingAgent: 'O agente está inicializando — isso pode levar um minuto…',
        takingLonger: 'Ainda trabalhando. O agente está demorando mais do que o normal.',
        cancel: 'Cancelar',
        retry: 'Tentar novamente',
        failedActionable: ({ machineName }: { machineName: string }) => `Não foi possível alcançar o agente em ${machineName}. Tente reiniciar o daemon nessa máquina.`,
        failedNoMachine: 'Não foi possível alcançar o agente. Tente reiniciar o daemon nessa máquina.',
        openMachineDetails: 'Abrir detalhes da máquina',
    ...
    home: {
        ...
        onboarding: {
            title: 'Voce entrou!',
            subtitle: 'Conecte sua primeira maquina.',
            step1Title: 'Conta criada',
            step1Subtitle: 'Login realizado com sucesso',
            step2Title: 'Conectar uma maquina',
            step2Subtitle: 'Execute este comando em qualquer maquina',
            step2Hint: 'Execute no terminal. A maquina aparecera aqui automaticamente.',
            step3Title: 'Criar um time',
            step3Subtitle: 'Monte seu primeiro time de agentes IA',
            commandCopiedTitle: 'Copiado!',
            commandCopiedMessage: 'Cole este comando no terminal para conectar uma maquina.',
        },
        ...
        addDeviceSubtitle: 'Copie este comando para vincular qualquer maquina a este servidor e conta',
        addDeviceHint: 'Cole isso em um terminal de qualquer maquina. Ele fixa o servidor atual e depois entra na sua conta.',
        joinCommandExpiresIn: ({ time }: { time: string }) => `O comando de entrada expira em ${time}`,
        joinCommandExpired: 'O comando de entrada expirou. Atualize para gerar um novo.',
    ...
    settingsAccount: {
        ...
        professionalModeSubtitle: 'Mostra configuração detalhada de agentes, hooks, servidores MCP e espelhos de spec em toda a sua conta.',
        professionalModeLocked: 'Ative o modo profissional nas configurações da conta para ver a configuração detalhada do agente e os detalhes internos do runtime.',
        profile: 'Perfil',
        name: 'Nome',
        github: 'GitHub',
        ...
        logoutConfirm: 'Tem certeza de que quer sair? Depois voce pode precisar de outro dispositivo conectado para adicionar esta maquina novamente.',
    },
    ...
    welcome: {
        ...
        otpSentTo: ({ email }: { email: string }) => `Codigo enviado para ${email}`,
        verifyCode: 'Verificar',
        resendCode: 'Reenviar codigo',
        resendIn: ({ seconds }: { seconds: number }) => `Reenviar em ${seconds}s`,
        changeEmail: 'Alterar email',
        restoreRequired: 'Conta ja existe',
        restoreRequiredMessage: 'Esta conta ja tem dados. Abra "Adicionar novo dispositivo" em outro dispositivo conectado e execute aqui o comando de entrada.',
        restoreRecoveryNotReadyTitle: 'O material de recuperacao ainda nao esta pronto',
        restoreRecoveryNotReadyMessage: 'Esta conta do Google esta vinculada a uma conta existente, mas o material de recuperacao ainda nao esta pronto no servidor. Abra "Adicionar novo dispositivo" em outro dispositivo conectado e execute aqui o comando real de entrada.',
        googleCallbackFailedTitle: 'Falha no login com Google',
        googleCallbackFailedMessage: ({ reason }: { reason: string }) => `Nao foi possivel concluir o login com Google. ${reason}`,
        googleSignInFailedFallback: 'Falha no login com Google. Tente novamente.',
        haveAnotherLoggedInDevice: 'Tenho outro dispositivo conectado',
        restoreWhyTitle: 'Como continuar?',
        loggedInDeviceHelp: 'Esta pagina nao pode gerar um codigo real de entrada. Abra "Adicionar novo dispositivo" em outro dispositivo conectado e copie de la o comando real.',
        loggedInDeviceHelpRecoveryNotReady: 'Isto nao e uma falha do login do Google. O material de recuperacao desta conta ainda nao esta pronto, entao o caminho mais rapido e abrir "Adicionar novo dispositivo" em outro dispositivo conectado e executar aqui o comando real.',
        switchGoogleAccount: 'Trocar conta do Google',
    ...
    machine: {
        ...
        archivedNotice: 'Esta máquina está arquivada',
        archivedHelp: 'Restaure-a antes de usá-la em novas sessões ou lançamentos de equipes.',
        daemon: 'Daemon',
        status: 'Status',
        daemonLikelyAlive: 'provavelmente ativo',
        daemonStopped: 'parado',
        stopDaemon: 'Parar daemon',
        stopDaemonTitle: 'Parar daemon?',
        stopDaemonConfirm: 'Você não poderá iniciar novas sessões nesta máquina até reiniciar o daemon no seu computador. Suas sessões atuais continuarão ativas.',
        ...
        lifecycleStatus: 'Disponibilidade',
        statusAvailable: 'disponível',
        statusArchived: 'arquivada',
        archiveMachine: 'Arquivar máquina',
        archiveMachineConfirm: 'Arquivar esta máquina? Ela desaparecerá dos seletores normais até você restaurá-la.',
        archiveMachineHelp: 'Oculta esta máquina dos fluxos normais sem apagar seu registro.',
        archiveMachineSuccess: 'Máquina arquivada.',
        archiveMachineFailed: 'Falha ao arquivar a máquina.',
        restoreMachine: 'Restaurar máquina',
        restoreMachineConfirm: 'Restaurar esta máquina arquivada de volta ao workspace?',
        restoreMachineHelp: 'Torna esta máquina disponível novamente nos launchers.',
        restoreMachineSuccess: 'Máquina restaurada.',
        restoreMachineFailed: 'Falha ao restaurar a máquina.',
        deleteMachine: 'Excluir máquina',
        deleteMachineConfirm: 'Excluir esta máquina permanentemente? Isso removerá o registro salvo da sua conta.',
        deleteMachineHelp: 'Remove permanentemente este registro de máquina offline.',
        deleteMachineDisabledActive: 'Pare o daemon ou aguarde esta máquina ficar offline antes de excluí-la.',
        deleteMachineSuccess: 'Máquina excluída.',
        deleteMachineFailed: 'Falha ao excluir a máquina.',
        archiveMachineDisabledActive: 'Pare o daemon ou aguarde esta máquina ficar offline antes de arquivá-la.',
        renameMachine: 'Renomear máquina',
        renamePrompt: 'Dê a esta máquina um nome personalizado. Deixe em branco para usar o hostname padrão.',
        renamePlaceholder: 'Digite o nome da máquina',
        renameSuccess: 'Máquina renomeada com sucesso.',
        ...
        createDirectoryConfirm: ({ directory }: { directory: string }) => `O diretório '${directory}' não existe. Deseja criá-lo?`,
        startSessionFailed: 'Falha ao iniciar a sessão. Verifique se o daemon ainda está rodando na máquina de destino.',
    ...
    agents: {
        ...
        newCorps: 'Novo corpo',
        buildCorpsTitle: 'Construir seu corpo',
        buildCorpsAddRole: 'Adicionar papel',
        buildCorpsEmptyHint: 'Adicione papéis para começar a construir seu corpo',
        buildCorpsStart: 'Iniciar corpo',
