...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        archivedMachines: 'Zarchiwizowane maszyny',
        showAllArchivedMachines: ({ count }: { count: number }) => `Pokaż wszystkie zarchiwizowane (${count})`,
        showLessArchivedMachines: 'Pokaż mniej zarchiwizowanych maszyn',
        features: 'Funkcje',
        social: 'Społeczność',
        account: 'Konto',
    ...
    newSession: {
        ...
        sessionTimeout: 'Agent wciąż się uruchamia. Otwórz maszynę, aby zobaczyć, kiedy się pojawi, lub spróbuj ponownie za chwilę.',
    ...
    sessionStarting: {
        ...
        connecting: 'Łączenie z maszyną…',
        bootingAgent: 'Agent się uruchamia — może to chwilę potrwać…',
        takingLonger: 'Wciąż pracuję. Agent uruchamia się dłużej niż zwykle.',
        cancel: 'Anuluj',
        retry: 'Spróbuj ponownie',
        failedActionable: ({ machineName }: { machineName: string }) => `Nie udało się skontaktować z agentem na ${machineName}. Spróbuj zrestartować daemon na tej maszynie.`,
        failedNoMachine: 'Nie udało się skontaktować z agentem. Spróbuj zrestartować daemon na tej maszynie.',
        openMachineDetails: 'Otwórz szczegóły maszyny',
        debugDiagnosticId: ({ id }: { id: string }) => `Id diagnostyczne: ${id}`,
    },
    ...
    home: {
        ...
        onboarding: {
            title: 'Jestes w srodku!',
            subtitle: 'Podlacz swoja pierwsza maszyne.',
            step1Title: 'Konto utworzone',
            step1Subtitle: 'Logowanie zakonczone sukcesem',
            step2Title: 'Podlacz maszyne',
            step2Subtitle: 'Uruchom te komende na dowolnej maszynie',
            step2Hint: 'Uruchom w terminalu. Maszyna pojawi sie tutaj automatycznie.',
            step3Title: 'Utworz zespol',
            step3Subtitle: 'Skonfiguruj swoj pierwszy zespol agentow AI',
            commandCopiedTitle: 'Skopiowano!',
            commandCopiedMessage: 'Wklej te komende w terminalu, aby podlaczyc maszyne.',
        },
        ...
        addDeviceTitle: 'Dodaj nowe urzadzenie',
        addDeviceSubtitle: 'Skopiuj te komende, aby podlaczyc dowolna maszyne do tego serwera i konta',
        addDeviceHint: 'Wklej ja w terminalu na dowolnej maszynie. Najpierw przypnie biezacy serwer, potem dolaczy konto.',
        joinCommandExpiresIn: ({ time }: { time: string }) => `Komenda dolaczenia wygasa za ${time}`,
        joinCommandExpired: 'Komenda dolaczenia wygasla. Odswiez, aby wygenerowac nowa.',
    ...
    settingsAccount: {
        ...
        professionalMode: 'Tryb profesjonalny',
        professionalModeSubtitle: 'Pokazuj szczegółową konfigurację agentów, hooki, serwery MCP i lustrzane specyfikacje w całym koncie.',
        professionalModeLocked: 'Włącz tryb profesjonalny w ustawieniach konta, aby zobaczyć szczegółową konfigurację agenta i wewnętrzne szczegóły środowiska uruchomieniowego.',
        profile: 'Profil',
        name: 'Nazwa',
        github: 'GitHub',
        ...
        logoutConfirm: 'Czy na pewno chcesz sie wylogowac? Pozniej mozesz potrzebowac innego zalogowanego urzadzenia, aby ponownie dolaczyc te maszyne.',
    },
    ...
    welcome: {
        ...
        signInWithGoogle: 'Zaloguj sie przez Google',
        signInWithEmail: 'Zaloguj sie przez email',
        emailSignInUnavailable: 'Logowanie przez email jest obecnie niedostepne. Uzyj logowania przez Google.',
        emailPlaceholder: 'twoj@email.com',
        sendCode: 'Wyslij kod',
        otpPlaceholder: '6-cyfrowy kod',
        otpSentTo: ({ email }: { email: string }) => `Kod wyslany na ${email}`,
        verifyCode: 'Zweryfikuj',
        resendCode: 'Wyslij ponownie',
        resendIn: ({ seconds }: { seconds: number }) => `Ponow za ${seconds}s`,
        changeEmail: 'Zmien email',
        restoreRequired: 'Konto juz istnieje',
        restoreRequiredMessage: 'To konto juz ma dane. Otworz "Dodaj nowe urzadzenie" na innym zalogowanym urzadzeniu i uruchom tutaj komende dolaczenia.',
        restoreRecoveryNotReadyTitle: 'Material odzyskiwania nie jest jeszcze gotowy',
        restoreRecoveryNotReadyMessage: 'To konto Google jest polaczone z istniejacym kontem, ale material odzyskiwania nie jest jeszcze gotowy na serwerze. Otworz "Dodaj nowe urzadzenie" na innym zalogowanym urzadzeniu i uruchom tutaj prawdziwa komende dolaczenia.',
        googleCallbackFailedTitle: 'Logowanie przez Google nie powiodlo sie',
        googleCallbackFailedMessage: ({ reason }: { reason: string }) => `Nie udalo sie zakonczyc logowania przez Google. ${reason}`,
        googleSignInFailedFallback: 'Logowanie przez Google nie powiodlo sie. Sprobuj ponownie.',
        haveAnotherLoggedInDevice: 'Mam inne zalogowane urzadzenie',
        restoreWhyTitle: 'Jak mam kontynuowac?',
        loggedInDeviceHelp: 'Ta strona nie moze wygenerowac prawdziwego kodu dolaczenia. Otworz "Dodaj nowe urzadzenie" na innym zalogowanym urzadzeniu i skopiuj stamtad prawdziwe polecenie.',
        loggedInDeviceHelpRecoveryNotReady: 'To nie jest blad logowania Google. Material odzyskiwania dla tego konta nie jest jeszcze gotowy, wiec najszybsza sciezka to otworzyc "Dodaj nowe urzadzenie" na innym zalogowanym urzadzeniu i uruchomic tutaj prawdziwe polecenie.',
        switchGoogleAccount: 'Przelacz konto Google',
    ...
    machine: {
        ...
        archivedNotice: 'Ta maszyna jest zarchiwizowana',
        archivedHelp: 'Przywróć ją przed użyciem do nowych sesji lub uruchomień zespołu.',
        daemon: 'Daemon',
        status: 'Status',
        daemonLikelyAlive: 'prawdopodobnie działa',
        daemonStopped: 'zatrzymany',
        stopDaemon: 'Zatrzymaj daemon',
        stopDaemonTitle: 'Zatrzymać daemon?',
        stopDaemonConfirm: 'Nie będzie można uruchamiać nowych sesji na tej maszynie, dopóki ponownie nie uruchomisz daemona na komputerze. Bieżące sesje pozostaną aktywne.',
        stopDaemonFailed: 'Nie udało się zatrzymać daemona. Być może nie działa.',
        ...
        lifecycleStatus: 'Dostępność',
        statusAvailable: 'dostępna',
        statusArchived: 'zarchiwizowana',
        archiveMachine: 'Archiwizuj maszynę',
        archiveMachineConfirm: 'Zarchiwizować tę maszynę? Zniknie ze zwykłych selektorów, dopóki jej nie przywrócisz.',
        archiveMachineHelp: 'Ukryj tę maszynę w normalnych przepływach bez usuwania rekordu.',
        archiveMachineSuccess: 'Maszyna zarchiwizowana.',
        archiveMachineFailed: 'Nie udało się zarchiwizować maszyny.',
        restoreMachine: 'Przywróć maszynę',
        restoreMachineConfirm: 'Przywrócić tę zarchiwizowaną maszynę do workspace?',
        restoreMachineHelp: 'Ponownie udostępnij tę maszynę w launcherach.',
        restoreMachineSuccess: 'Maszyna przywrócona.',
        restoreMachineFailed: 'Nie udało się przywrócić maszyny.',
        deleteMachine: 'Usuń maszynę',
        deleteMachineConfirm: 'Usunąć tę maszynę na stałe? To usunie zapisany rekord z konta.',
        deleteMachineHelp: 'Trwale usuń rekord tej offline maszyny.',
        deleteMachineDisabledActive: 'Zatrzymaj daemon lub poczekaj, aż ta maszyna przejdzie offline, zanim ją usuniesz.',
        deleteMachineSuccess: 'Maszyna usunięta.',
        deleteMachineFailed: 'Nie udało się usunąć maszyny.',
        archiveMachineDisabledActive: 'Zatrzymaj daemon lub poczekaj, aż ta maszyna przejdzie offline, zanim ją zarchiwizujesz.',
        renameMachine: 'Zmień nazwę maszyny',
        renamePrompt: 'Nadaj tej maszynie własną nazwę. Pozostaw puste, aby użyć domyślnej nazwy hosta.',
        renamePlaceholder: 'Wpisz nazwę maszyny',
        renameSuccess: 'Pomyślnie zmieniono nazwę maszyny.',
        ...
        createDirectoryConfirm: ({ directory }: { directory: string }) => `Katalog '${directory}' nie istnieje. Czy chcesz go utworzyć?`,
        startSessionFailed: 'Nie udało się uruchomić sesji. Upewnij się, że daemon nadal działa na maszynie docelowej.',
        activeSessions: ({ count }: { count: number }) => `Aktywne sesje (${count})`,
        previousSessions: 'Poprzednie sesje (maks. 5 najnowszych)',
    ...
    agents: {
        ...
        newCorps: 'Nowy korpus',
        buildCorpsTitle: 'Zbuduj swój korpus',
        buildCorpsAddRole: 'Dodaj rolę',
        buildCorpsEmptyHint: 'Dodaj role, aby zacząć budować korpus',
        buildCorpsStart: 'Uruchom korpus',
        buildCorpsDefaultName: 'My Corps',
        buildCorpsSave: 'Save Template',
        buildCorpsSavedTitle: 'Corps Saved',
        buildCorpsSavedMessage: 'Corps template saved to your library. You can run it later.',
