...
export const es: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        backupDescription: 'El acceso normal a tu cuenta es con Google y comandos de union de un solo uso. Guarda esta clave secreta solo como respaldo de emergencia.',
    ...
    welcome: {
        ...
        restoreRequiredMessage: 'Esta cuenta ya tiene datos. Ingresa tu clave de restauracion.',
        restoreRecoveryNotReadyTitle: 'El material de recuperacion aun no esta listo',
        restoreRecoveryNotReadyMessage: 'Esta cuenta de Google esta vinculada a una cuenta existente, pero el material de recuperacion aun no esta listo en el servidor. Usa una clave de restauracion existente o abre "Agregar nuevo dispositivo" en otro dispositivo conectado.',
        restoreSecretMismatchTitle: 'La clave de este dispositivo no coincide con la cuenta',
        restoreSecretMismatchMessage: 'Esta cuenta de Google esta vinculada a una cuenta existente, pero este navegador guarda otra clave local. Ingresa la clave correcta o agrega esta maquina desde otro dispositivo conectado.',
        restoreKeyPlaceholder: 'XXXXX-XXXXX-XXXXX-...',
        restoreSubmit: 'Restaurar',
        enterRestoreKeyFirst: 'Ingresa primero la clave',
        copyRestoreCommand: 'Copiar comando de restauracion',
        restoreCommandNeedsKeyMessage: 'Primero ingresa tu clave real de restauracion. Esta pagina no puede inventarla ni recuperarla por ti.',
        restoreCommandCopiedMessage: 'Comando de restauracion copiado. Reemplaza el marcador con tu clave de restauracion y luego ejecutalo.',
        ...
        loggedInDeviceHelpSecretMismatch: 'Este dispositivo ahora mismo guarda otra clave local, asi que no puede recuperar automaticamente la cuenta existente. Usa la clave original o agrega esta maquina desde otro dispositivo conectado.',
