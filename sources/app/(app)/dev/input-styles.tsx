                ...
                <View style={{ backgroundColor: '#36393f' }}>
                    <View style={{ padding: 16 }}>
                        <View style={{
                            ...
                            <Pressable style={{ marginLeft: 12 }}>
                                <Ionicons name="image-outline" size={24} color="#b9bbbe" />
                            </Pressable>
                            <Pressable style={{ marginLeft: 12 }}>
                    ...
                    <View style={{
                        ...
                        <Pressable style={{ padding: 4, marginRight: 8 }}>
                            <Ionicons name="gift-outline" size={18} color="#b9bbbe" />
                        </Pressable>
                        <Pressable style={{ padding: 4, marginRight: 8 }}>
                            <Ionicons name="document-text-outline" size={18} color="#b9bbbe" />
                        </Pressable>
            ...
            preview: (
                <View style={{ backgroundColor: '#fcfcfc' }}>
                    ...
                    <View style={{
                        ...
                        <Pressable style={{ marginRight: 16 }}>
                            <Ionicons name="pricetag-outline" size={18} color="#6a737d" />
                        </Pressable>
                        <Pressable style={{ marginRight: 16 }}>
                    ...
                    <View style={{ padding: 16 }}>
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <Pressable style={{ marginRight: 16 }}>
                                    <Ionicons name="code-slash-outline" size={18} color="#586069" />
                                </Pressable>
                                <Pressable style={{ marginRight: 16 }}>
                                    <Ionicons name="link-outline" size={18} color="#586069" />
                                </Pressable>
                                <Pressable style={{ marginRight: 16 }}>
                                    <Ionicons name="list-outline" size={18} color="#586069" />
                                </Pressable>
                                <Pressable>
                                    <Ionicons name="list-outline" size={18} color="#586069" />
                                </Pressable>
                    ...
                    <View style={{ padding: 16 }}>
                        <View style={{
                            ...
                            <View style={{
                                ...
                                />
                                <Pressable style={{ marginLeft: 8 }}>
                                    <Ionicons name="send-outline" size={24} color="#1976d2" />
                                </Pressable>
                            </View>
                        </View>
                    </View>
                ...
                <View style={{ backgroundColor: '#1a1a1b' }}>
                    <View style={{ padding: 12 }}>
                        ...
                        <View style={{
                            ...
                            <Pressable style={{ padding: 8 }}>
                                <Ionicons name="link-outline" size={18} color="#818384" />
                            </Pressable>
                            <Pressable style={{ padding: 8 }}>
                                <Octicons name="strikethrough" size={18} color="#818384" />
                            </Pressable>
                            <Pressable style={{ padding: 8 }}>
                                <Ionicons name="code-slash-outline" size={18} color="#818384" />
                            </Pressable>
                            <View style={{ flex: 1 }} />
                            <Pressable style={{
                                paddingHorizontal: 16,
            ...
            preview: (
                <View style={{ backgroundColor: '#202020' }}>
                    ...
                    <View style={{
                        ...
                        <Pressable style={{ padding: 6, marginRight: 8 }}>
                            <Ionicons name="pricetag-outline" size={18} color="#7f6df2" />
                        </Pressable>
                        <Pressable style={{ padding: 6, marginRight: 8 }}>
                            <Octicons name="bold" size={18} color="#666" />
                        </Pressable>
                        ...
                        <Pressable style={{ padding: 6, marginRight: 8 }}>
                            <Ionicons name="code-slash-outline" size={18} color="#666" />
                        </Pressable>
                        <View style={{ flex: 1 }} />
                        <Pressable style={{
                            flexDirection: 'row',
                    ...
                    <View style={{ padding: 12 }}>
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <Pressable style={{ marginRight: 16 }}>
                                    <Ionicons name="text" size={20} color="#605e5c" />
                                </Pressable>
                                <Pressable style={{ marginRight: 16 }}>
                                    <Ionicons name="color-fill-outline" size={20} color="#605e5c" />
                                </Pressable>
                                <View style={{ flex: 1 }} />
                                <Pressable>
                                    <Ionicons name="ellipsis-horizontal" size={20} color="#605e5c" />
                                </Pressable>
                            </View>
                            <TextInput
                                style={{ 
                            ...
                            <View style={{
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    <Pressable>
                                        <Ionicons name="image-outline" size={20} color="#605e5c" />
                                    </Pressable>
                                </View>
                                <Pressable style={{
