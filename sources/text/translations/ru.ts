...
export const ru: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        backupDescription: 'Обычный вход обратно в аккаунт идет через Google и одноразовые команды подключения. Храните этот ключ только как аварийную резервную копию.',
    ...
    welcome: {
        ...
        restoreRequiredMessage: 'У этого аккаунта уже есть данные. Введите ключ восстановления.',
        restoreRecoveryNotReadyTitle: 'Материал восстановления еще не готов',
        restoreRecoveryNotReadyMessage: 'Этот Google аккаунт уже связан с существующим аккаунтом, но материал восстановления на сервере еще не готов. Используйте существующий ключ восстановления или откройте "Добавить новое устройство" на другом вошедшем устройстве.',
        restoreSecretMismatchTitle: 'Ключ этого устройства не совпадает с аккаунтом',
        restoreSecretMismatchMessage: 'Этот Google аккаунт уже связан с существующим аккаунтом, но этот браузер хранит другой локальный ключ. Введите правильный ключ восстановления или добавьте эту машину с другого вошедшего устройства.',
        restoreKeyPlaceholder: 'XXXXX-XXXXX-XXXXX-...',
        restoreSubmit: 'Восстановить',
        enterRestoreKeyFirst: 'Сначала введите ключ',
        copyRestoreCommand: 'Скопировать команду восстановления',
        restoreCommandNeedsKeyMessage: 'Сначала введите ваш настоящий ключ восстановления. Эта страница не может придумать или получить его за вас.',
        restoreCommandCopiedMessage: 'Команда восстановления скопирована. Замените заполнитель своим ключом восстановления и запустите ее.',
        ...
        loggedInDeviceHelpSecretMismatch: 'Это устройство сейчас хранит другой локальный ключ, поэтому не может автоматически вернуть существующий аккаунт. Используйте исходный ключ восстановления или добавьте эту машину с другого вошедшего устройства.',
