...
import { type NavTabKey, NAV_TABS } from '@/navigation/navigationConfig';

/** @deprecated Use NavTabKey from '@/navigation/navigationConfig' instead. */
export type TabType = NavTabKey | 'zen';
...
export const TabBar = React.memo(({ activeTab, onTabPress }: TabBarProps) => {
    ...
    const tabs: { key: TabType; icon: any; label: string }[] = React.useMemo(() => {
        ...
        // Add regular tabs from shared config
