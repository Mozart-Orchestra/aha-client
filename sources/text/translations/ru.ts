...
export const ru: TranslationStructure = {
    ...
    welcome: {
        ...
        loggedInDeviceHelp: 'Откройте "Добавить новое устройство" на этом вошедшем устройстве и скопируйте сюда его команду присоединения.',
        copyJoinCommand: 'Скопировать шаблон команды присоединения',
        joinDeviceCommandCopiedMessage: 'Шаблон команды присоединения скопирован. Сначала сгенерируйте реальную команду на другом вошедшем устройстве.',
