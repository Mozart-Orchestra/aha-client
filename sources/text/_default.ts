...
export const en = {
    ...
    welcome: {
        ...
        restoreRequiredMessage: 'This account already has data. Enter your restore key to access it.',
        restoreRecoveryNotReadyTitle: 'Recovery material not ready',
        restoreRecoveryNotReadyMessage: 'This Google account is linked to an existing account, but recovery material is not ready on the server yet. Use an existing restore key, or open "Add New Device" on another signed-in device.',
        restoreSecretMismatchTitle: 'This device key does not match the account',
        restoreSecretMismatchMessage: 'This Google account is linked to an existing account, but this browser is holding a different local key. Enter the correct restore key, or add this machine from another signed-in device.',
        restoreKeyPlaceholder: 'XXXXX-XXXXX-XXXXX-...',
        restoreSubmit: 'Restore',
        enterRestoreKeyFirst: 'Enter restore key first',
        copyRestoreCommand: 'Copy restore command',
        restoreCommandNeedsKeyMessage: 'Enter your real restore key first. This page cannot invent or fetch it for you.',
        restoreCommandCopiedMessage: 'Restore command copied. Replace the placeholder with your restore key, then run it.',
        ...
        loggedInDeviceHelpSecretMismatch: 'This device is currently holding a different local key, so it cannot auto-recover the existing account. Use the original restore key, or add this machine from another signed-in device.',
