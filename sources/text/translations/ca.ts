...
export const ca: TranslationStructure = {
    ...
    welcome: {
        ...
        loggedInDeviceHelp: 'Obre "Afegeix un dispositiu nou" en aquest dispositiu connectat i copia aqui la seva ordre d\'unio.',
        copyJoinCommand: 'Copia la plantilla de l\'ordre d\'unio',
        joinDeviceCommandCopiedMessage: 'Plantilla de l\'ordre d\'unio copiada. Genera l\'ordre real des de l\'altre dispositiu connectat abans d\'executar-la.',
