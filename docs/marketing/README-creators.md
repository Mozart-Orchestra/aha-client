# Aha Coder Content Creator Brief

## Key Features

Aha Coder is an open-source mobile app that lets developers control AI coding agents (Claude Code, Codex, Gemini-CLI) from their phone.
...
- On Aha Coder, I can manage Claude Code from my phone without paying $600/year
- On Aha Coder, I never miss when Claude gets stuck on a permission prompt
- Aha Coder runs on my own computer, not expensive cloud servers
- On Aha Coder, I can check on long-running tasks without returning to my desk
- Aha Coder is open source - I can audit, modify, or self-host everything
- On Aha Coder, I can run multiple agents in parallel and switch between them instantly
- Aha Coder keeps my code on my machines with end-to-end encryption
- On Aha Coder, I can keep coding while commuting, eating, or away from my desk

## Example Hooks

- "I saved $600/year by switching from [competitor] to the open-source Aha Coder"
...
- Clearly say "Aha Coder" in the video or caption
- Mention it's free and open source
- Include link to github.com/slopus/aha
...
- GitHub: https://github.com/slopus/aha
- Website: https://aha.engineering
- iOS App: https://apps.apple.com/us/app/aha-claude-code-client/id6748571505
- Android App: https://play.google.com/store/apps/details?id=com.ex3ndr.aha
- Web App: https://app.aha.engineering/