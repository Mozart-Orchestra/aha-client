...
export const pl: TranslationStructure = {
    ...
    welcome: {
        ...
        restoreRequiredMessage: 'To konto juz ma dane. Wprowadz klucz przywracania.',
        restoreRecoveryNotReadyTitle: 'Material odzyskiwania nie jest jeszcze gotowy',
        restoreRecoveryNotReadyMessage: 'To konto Google jest polaczone z istniejacym kontem, ale material odzyskiwania nie jest jeszcze gotowy na serwerze. Uzyj istniejacego klucza albo otworz "Dodaj nowe urzadzenie" na innym zalogowanym urzadzeniu.',
        restoreSecretMismatchTitle: 'Klucz tego urzadzenia nie pasuje do konta',
        restoreSecretMismatchMessage: 'To konto Google jest polaczone z istniejacym kontem, ale ta przegladarka przechowuje inny lokalny klucz. Wpisz poprawny klucz albo dodaj te maszyne z innego zalogowanego urzadzenia.',
        restoreKeyPlaceholder: 'XXXXX-XXXXX-XXXXX-...',
        restoreSubmit: 'Przywroc',
        enterRestoreKeyFirst: 'Najpierw wpisz klucz',
        copyRestoreCommand: 'Skopiuj polecenie przywracania',
        restoreCommandNeedsKeyMessage: 'Najpierw wpisz prawdziwy klucz przywracania. Ta strona nie moze go wymyslic ani pobrac za ciebie.',
        restoreCommandCopiedMessage: 'Polecenie przywracania skopiowane. Zamien znacznik na swoj klucz przywracania i uruchom polecenie.',
        ...
        loggedInDeviceHelpSecretMismatch: 'To urzadzenie trzyma teraz inny lokalny klucz, wiec nie moze automatycznie odzyskac istniejacego konta. Uzyj oryginalnego klucza albo dodaj te maszyne z innego zalogowanego urzadzenia.',
