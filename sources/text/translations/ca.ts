...
export const ca: TranslationStructure = {
    ...
    home: {
        ...
        addDeviceSubtitle: 'Copia aquesta comanda per vincular qualsevol maquina al teu compte',
        addDeviceHint: 'Enganxa-ho en un terminal de qualsevol maquina per unir-la al teu compte.',
