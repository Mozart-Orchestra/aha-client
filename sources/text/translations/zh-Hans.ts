...
export const zhHans: TranslationStructure = {
    ...
    channels: {
        ...
        weixinDisconnected: '微信已断开。',
        weixinQrExpired: '二维码已过期，请重新生成后扫码。',
        weixinBindHint: '绑定您的微信机器人，接收 Agent 消息并通过微信回复。',
        weixinPushPolicyCurrent: ({ policy }: { policy: string }) => `推送策略：${policy}`,
        weixinScanWaiting: '等待扫码确认...',
        weixinQrHint: '用微信扫描此二维码，确认后页面将自动绑定。',
    ...
    settingsAccount: {
        ...
        restoreCommandLabel: '恢复命令（点击复制）',
        restoreCommandCopied: '命令已复制！在新机器上粘贴运行即可接入。',
        restoreCommandCopyFailed: '复制恢复命令失败',
        privacy: '隐私',
