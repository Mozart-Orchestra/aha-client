...
aha is the secure mobile companion for Claude Code that lets you continue your AI coding sessions anywhere (not affiliated with Anthropic). Built by developers who needed to check on Claude's progress during coffee breaks, this app brings the full Claude Code experience to your phone with military-grade encryption.

**Important**: This app requires Claude Code to be installed on your computer. aha is a companion app that connects to your existing Claude Code setup.
...
**How It Works:**
1. Install the aha-coder CLI on your computer
...
aha uses the same encryption as Signal (TweetNaCl) and is completely open source. Your encryption keys never leave your device, and all data is encrypted before transmission.
...
### Privacy Policy
https://github.com/slopus/aha-coder/blob/main/PRIVACY.md

### Support / Contact
https://github.com/slopus/aha-coder/issues

### Website / Marketing
https://github.com/slopus/aha-coder
