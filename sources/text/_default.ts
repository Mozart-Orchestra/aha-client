...
export const en = {
    ...
    home: {
        ...
        addDeviceSubtitle: 'Copy this command to link any machine to your account',
        addDeviceHint: 'Paste this in a terminal on any machine. It will join your account instantly.',
