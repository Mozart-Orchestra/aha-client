...
export const zhHans: TranslationStructure = {
    ...
    welcome: {
        ...
        restoreRequiredMessage: '此账户已有数据，请输入 Restore Key 恢复。',
        restoreRecoveryNotReadyTitle: '恢复材料尚未就绪',
        restoreRecoveryNotReadyMessage: '这个 Google 账号已关联到现有账户，但服务器还没有可用的恢复材料。请使用已保存的 Restore Key，或在另一台已登录设备上打开“加入新设备”。',
        restoreSecretMismatchTitle: '当前设备密钥与账户不一致',
        restoreSecretMismatchMessage: '这个 Google 账号已绑定现有账户，但当前浏览器持有的是另一把本地密钥。请输入正确的 Restore Key，或在另一台已登录设备上把这台设备加入进来。',
        restoreKeyPlaceholder: 'XXXXX-XXXXX-XXXXX-...',
        restoreSubmit: '恢复',
        enterRestoreKeyFirst: '先输入 Restore Key',
        copyRestoreCommand: '复制恢复命令',
        restoreCommandNeedsKeyMessage: '请先输入你真实的 Restore Key。当前页面无法替你生成，也无法替你取回它。',
        restoreCommandCopiedMessage: '恢复命令已复制。将占位符替换为你的 Restore Key 后运行即可。',
        ...
        loggedInDeviceHelpSecretMismatch: '这台设备当前持有的是另一把本地密钥，所以不能直接自动接回原账户。请使用原账户的 Restore Key，或在另一台已登录设备上把这台机器加入进去。',
