...
export const en = {
    ...
    settings: {
        ...
        archivedMachines: 'Archived Machines',
        showAllArchivedMachines: ({ count }: { count: number }) => `Show all archived (${count})`,
        showLessArchivedMachines: 'Show fewer archived machines',
        features: 'Features',
        social: 'Social',
        account: 'Account',
    ...
    server: {
        ...
        notValidServer: 'Not a valid Aha Server',
    ...
    sessionInfo: {
        ...
        sessionIdCopied: 'Aha Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Aha Session ID',
        sessionId: 'Aha Session ID',
        ...
        restoreSessionSubtitle: 'Restore this session to your workspace',
        metadata: 'Metadata',
        host: 'Host',
        path: 'Path',
        operatingSystem: 'Operating System',
        processId: 'Process ID',
        homeDirectory: 'Aha Home',
    ...
    home: {
        ...
        onboarding: {
            title: 'You\'re in!',
            subtitle: 'Let\'s get your first machine connected.',
            step1Title: 'Account created',
            step1Subtitle: 'Signed in successfully',
            step2Title: 'Connect a machine',
            step2Subtitle: 'Run this command on any machine to link it',
            step2Hint: 'Run this in your terminal. The machine will appear here automatically.',
            step3Title: 'Create a team',
            step3Subtitle: 'Set up your first AI agent team',
            commandCopiedTitle: 'Copied!',
            commandCopiedMessage: 'Paste this command in your terminal to connect a machine.',
        },
        ...
        addDeviceSubtitle: 'Copy this command to link any machine to this server and account',
        addDeviceHint: 'Paste this in a terminal on any machine. It pins the current server, then joins your account.',
        joinCommandExpiresIn: ({ time }: { time: string }) => `Join command expires in ${time}`,
        joinCommandExpired: 'Join command expired. Refresh to generate a new one.',
    ...
    settingsAccount: {
        ...
        professionalModeSubtitle: 'Show detailed agent configuration, hooks, MCP servers, and spec mirrors across your account.',
        professionalModeLocked: 'Enable Professional Mode in Account settings to reveal detailed agent configuration and runtime internals.',
        profile: 'Profile',
        name: 'Name',
        github: 'GitHub',
        ...
        logoutConfirm: 'Are you sure you want to logout? You may need another signed-in device to link this machine again.',
    },
    ...
    welcome: {
        ...
        otpSentTo: ({ email }: { email: string }) => `Verification code sent to ${email}`,
        verifyCode: 'Verify',
        resendCode: 'Resend code',
        resendIn: ({ seconds }: { seconds: number }) => `Resend in ${seconds}s`,
        changeEmail: 'Change email',
        restoreRequired: 'Account exists',
        restoreRequiredMessage: 'This account already has data. Open "Add New Device" on another signed-in device, then run the join command on this machine.',
        restoreRecoveryNotReadyTitle: 'Recovery material not ready',
        restoreRecoveryNotReadyMessage: 'This Google account is linked to an existing account, but recovery material is not ready on the server yet. Open "Add New Device" on another signed-in device and run the real join command here.',
        googleCallbackFailedTitle: 'Google sign-in failed',
        googleCallbackFailedMessage: ({ reason }: { reason: string }) => `Google sign-in could not be completed. ${reason}`,
        googleSignInFailedFallback: 'Google sign-in failed. Please try again.',
        haveAnotherLoggedInDevice: 'I have another signed-in device',
        restoreWhyTitle: 'How do I continue?',
        loggedInDeviceHelp: 'This page cannot generate a real join code. Open "Add New Device" on another signed-in device, then copy the real join command from there onto this machine.',
        loggedInDeviceHelpRecoveryNotReady: 'This is not a Google login failure. Recovery material for this account is not ready yet, so the fastest path is to open "Add New Device" on another signed-in device and run the real join command on this machine.',
    ...
    machine: {
        ...
        archivedNotice: 'This machine is archived',
        archivedHelp: 'Restore it before using it for new sessions or team launches.',
        daemon: 'Daemon',
        status: 'Status',
        ...
        stopDaemonConfirm: 'You will not be able to spawn new sessions on this machine until you restart the daemon on your computer again. Your current sessions will stay alive.',
        ...
        archiveMachineConfirm: 'Archive this machine? It will disappear from normal machine pickers until you restore it.',
        archiveMachineHelp: 'Hide this machine from normal launch flows without deleting its record.',
        archiveMachineSuccess: 'Machine archived.',
        archiveMachineFailed: 'Failed to archive machine.',
        restoreMachine: 'Restore Machine',
        restoreMachineConfirm: 'Restore this archived machine back into your workspace?',
        restoreMachineHelp: 'Make this machine available to launchers again.',
        restoreMachineSuccess: 'Machine restored.',
        restoreMachineFailed: 'Failed to restore machine.',
        deleteMachine: 'Delete Machine',
        deleteMachineConfirm: 'Delete this machine permanently? This removes its saved record from your account.',
        deleteMachineHelp: 'Permanently remove this offline machine record.',
        deleteMachineDisabledActive: 'Stop the daemon or wait for this machine to go offline before deleting it.',
        deleteMachineSuccess: 'Machine deleted.',
        deleteMachineFailed: 'Failed to delete machine.',
        archiveMachineDisabledActive: 'Stop the daemon or wait for this machine to go offline before archiving it.',
        renameMachine: 'Rename Machine',
        renamePrompt: 'Give this machine a custom name. Leave empty to use the default hostname.',
        ...
        createDirectoryConfirm: ({ directory }: { directory: string }) => `The directory '${directory}' does not exist. Would you like to create it?`,
    ...
    agents: {
        ...
        newCorps: 'Run Corps',
        buildCorpsTitle: 'Configure Corps',
        buildCorpsAddRole: 'Add Role',
        buildCorpsEmptyHint: 'Add roles to start configuring your corps',
        buildCorpsStart: 'Run Corps',
        buildCorpsDefaultName: 'My Corps',
        buildCorpsSave: 'Save Template',
        buildCorpsSavedTitle: 'Corps Saved',
        buildCorpsSavedMessage: 'Corps template saved to your library. You can run it from the Legion tab.',
        buildCorpsSaveFailed: 'Failed to save corps template.',
        buildCorpsSaveNoAuth: 'Sign in to save corps templates.',
        buildCorpsRunFailed: 'Failed to start corps.',
        useGlobalMachine: 'Use global machine',
        agentName: 'Agent Name',
        agentNamePlaceholder: 'e.g. My Builder Agent',
        agentRuntime: 'Runtime',
        agentRuntimeManualHint: 'In manual mode, this is the runtime saved into the final genome.',
        agentRuntimeChatHint: ({ builderName }: { builderName: string }) =>
            `In chat mode, this launches ${builderName} and keeps the authored genome aligned to that runtime.`,
        ...
        actionKeep: 'Keep',
        actionGuardrails: 'Guardrails',
        actionMutate: 'Mutate',
        actionDiscard: 'Discard',
        evolutionControls: 'Evolution Controls',
        evolutionTarget: 'Evolution Target',
        signInToEvolve: 'Sign in to manage evolution',
        signInToEvolveHint: 'Manual verdict, evolve, fork, and rollback require an authenticated account.',
        noEvolutionTarget: 'No linked genome image is available for this screen.',
        userVerdictTitle: 'User Verdict',
        userVerdictHint: 'Record a human judgment, then materialize it into the image feedback summary.',
        verdictScoreLabel: 'Score',
        verdictActionLabel: 'Action',
        verdictNotesLabel: 'Notes',
        verdictNotesPlaceholder: 'What worked, what failed, and what should happen next?',
        verdictNotesRequired: 'Add verdict notes before submitting.',
        submitVerdict: 'Submit Verdict',
        userVerdictSaved: 'Verdict saved and feedback materialized.',
        userVerdictFailed: 'Failed to save verdict.',
        manualEvolveTitle: 'Manual Evolve',
        manualEvolveHint: 'This appends a learning note into the image and creates a new version.',
        manualEvolvePlaceholder: 'Describe the learning or change that should be carried into the next version.',
        evolveNoteRequired: 'Add an evolution note before creating a new version.',
        createEvolvedVersion: 'Create New Version',
        manualEvolveSuccess: 'A new version was created from the manual evolve note.',
        manualEvolveFailed: 'Failed to create a new version.',
        forkTitle: 'Fork Image',
        forkNamespaceLabel: 'Fork Namespace',
        forkNameLabel: 'Fork Name',
        forkFieldsRequired: 'Fork namespace and fork name are required.',
        forkCreate: 'Create Fork',
        forkSuccess: 'Fork created successfully.',
        forkFailed: 'Failed to create fork.',
        versionHistoryTitle: 'Version History',
        noVersionHistory: 'No published version history is available yet.',
        currentVersion: 'Current',
        rollbackAction: 'Rollback',
        rollbackSuccess: ({ version }: { version: number }) => `Rolled back by creating a new head version from v${version}.`,
        rollbackFailed: 'Failed to roll back this image.',
        rollbackSourceMissing: 'The selected source version could not be loaded.',
        evidenceTitle: 'Trial Evidence',
        evidenceLoading: 'Loading trials and verdicts...',
        noEvidenceYet: 'No trial evidence yet',
        noEvidenceHint: 'Submit a user verdict or score this image from a live session to start the evidence chain.',
        trialLabel: ({ version }: { version: number }) => `Trial · v${version}`,
        sessionLabel: 'Session',
        noVerdictsForTrial: 'No verdicts recorded for this trial.',
        ...
        chatIntroTitle: 'Official Builder Chat',
        chatIntroBody: 'This launches the official builder lineage, not a page-local temporary agent. It reads bundled builder docs first, then syncs both the editable draft and the saveable spec back into this screen.',
        ...
        launchPrivateBuilderTitle: 'Launch The Official Builder',
        launchPrivateBuilderBody: 'Claude launches @official/agent-builder. Codex launches @official/agent-builder-codex. Create now prefers the builder-emitted spec instead of rebuilding a reduced local draft.',
        chatRunningTitle: 'Builder chat is live',
        chatRunningBody: 'Keep refining the request here. The right panel still mirrors the draft, but once the builder emits a spec sync, create saves that payload directly.',
        chatSpecStatusTitle: 'Builder Spec Sync',
        chatSpecPendingBody: ({ builderName }: { builderName: string }) =>
            `No saveable builder spec yet. ${builderName} is still only syncing the editable draft projection.`,
        chatSpecCompatibilityBody: ({ runtime }: { runtime: string }) =>
            `The builder has synced a saveable spec for ${runtime}, but some canonical agent.json blocks are still missing.`,
        chatSpecReadyBody: ({ runtime }: { runtime: string }) =>
            `The builder has synced a canonical agent.json for ${runtime}. Create will save this payload directly.`,
        chatSpecIdentity: 'Canonical identity',
        chatSpecPrompt: 'Prompt block',
        chatSpecTools: 'Tools block',
        chatSpecPermissions: 'Permissions block',
        chatSpecBehavior: 'Messaging + behavior',
        chatSpecPackaging: 'Market packaging',
        chatSpecExtras: 'Env / workspace / eval',
    ...
    teams: {
        ...
        restoreTeamConfirm: 'Restore this archived team and bring its archived sessions back into the workspace?',
        restoreAction: 'Restore',
        restoreTeamSuccess: ({ restoredSessions }: { restoredSessions: number }) => `Team restored with ${restoredSessions} sessions.`,
        restoreTeamFailed: 'Failed to restore team. Please try again.',
