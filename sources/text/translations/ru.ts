...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        archivedMachines: 'Архивные машины',
        showAllArchivedMachines: ({ count }: { count: number }) => `Показать все архивные (${count})`,
        showLessArchivedMachines: 'Показать меньше архивных машин',
        features: 'Функции',
        social: 'Социальное',
        account: 'Аккаунт',
    ...
    home: {
        ...
        onboarding: {
            title: 'Вы вошли!',
            subtitle: 'Подключите свою первую машину.',
            step1Title: 'Аккаунт создан',
            step1Subtitle: 'Вход выполнен успешно',
            step2Title: 'Подключить машину',
            step2Subtitle: 'Выполните эту команду на любой машине',
            step2Hint: 'Запустите в терминале. Машина появится здесь автоматически.',
            step3Title: 'Создать команду',
            step3Subtitle: 'Настройте первую команду ИИ-агентов',
            commandCopiedTitle: 'Скопировано!',
            commandCopiedMessage: 'Вставьте команду в терминал для подключения машины.',
        },
        ...
        addDeviceSubtitle: 'Скопируйте команду для подключения любой машины к этому серверу и аккаунту',
        addDeviceHint: 'Вставьте ее в терминал на любой машине. Сначала будет закреплен текущий сервер, затем подключен аккаунт.',
        joinCommandExpiresIn: ({ time }: { time: string }) => `Команда подключения истечет через ${time}`,
        joinCommandExpired: 'Срок действия команды подключения истек. Обновите ее, чтобы получить новую.',
    ...
    settingsAccount: {
        ...
        professionalModeSubtitle: 'Показывает подробную конфигурацию агентов, hooks, серверы MCP и зеркала spec для всей вашей учетной записи.',
        professionalModeLocked: 'Включите профессиональный режим в настройках аккаунта, чтобы увидеть подробную конфигурацию агента и внутренние детали runtime.',
        profile: 'Профиль',
        name: 'Имя',
        github: 'GitHub',
        ...
        logoutConfirm: 'Вы уверены, что хотите выйти? Потом может понадобиться другое вошедшее устройство, чтобы снова подключить эту машину.',
    },
    ...
    welcome: {
        ...
        otpSentTo: ({ email }: { email: string }) => `Код отправлен на ${email}`,
        verifyCode: 'Подтвердить',
        resendCode: 'Отправить повторно',
        resendIn: ({ seconds }: { seconds: number }) => `Повтор через ${seconds}с`,
        changeEmail: 'Изменить email',
        restoreRequired: 'Аккаунт уже существует',
        restoreRequiredMessage: 'У этого аккаунта уже есть данные. Откройте "Добавить новое устройство" на другом вошедшем устройстве и запустите здесь команду присоединения.',
        restoreRecoveryNotReadyTitle: 'Материал восстановления еще не готов',
        restoreRecoveryNotReadyMessage: 'Этот Google аккаунт уже связан с существующим аккаунтом, но материал восстановления на сервере еще не готов. Откройте "Добавить новое устройство" на другом вошедшем устройстве и запустите здесь реальную команду присоединения.',
        googleCallbackFailedTitle: 'Ошибка входа через Google',
        googleCallbackFailedMessage: ({ reason }: { reason: string }) => `Не удалось завершить вход через Google. ${reason}`,
        googleSignInFailedFallback: 'Не удалось войти через Google. Попробуйте еще раз.',
        haveAnotherLoggedInDevice: 'У меня есть другое вошедшее устройство',
        restoreWhyTitle: 'Как продолжить?',
        loggedInDeviceHelp: 'Эта страница не может создать реальный код присоединения. Откройте "Добавить новое устройство" на другом вошедшем устройстве и скопируйте оттуда реальную команду.',
        loggedInDeviceHelpRecoveryNotReady: 'Это не ошибка входа через Google. Материал восстановления для этого аккаунта еще не готов, поэтому самый быстрый путь — открыть "Добавить новое устройство" на другом вошедшем устройстве и запустить здесь реальную команду.',
        switchGoogleAccount: 'Сменить аккаунт Google',
    ...
    machine: {
        ...
        archivedNotice: 'Эта машина архивирована',
        archivedHelp: 'Восстановите её перед использованием для новых сессий или запусков команды.',
        daemon: 'Daemon',
        status: 'Статус',
        daemonLikelyAlive: 'вероятно запущен',
        daemonStopped: 'остановлен',
        stopDaemon: 'Остановить daemon',
        stopDaemonTitle: 'Остановить daemon?',
        stopDaemonConfirm: 'Вы не сможете запускать новые сессии на этой машине, пока снова не запустите daemon на компьютере. Текущие сессии продолжат работать.',
        ...
        lifecycleStatus: 'Доступность',
        statusAvailable: 'доступна',
        statusArchived: 'архивирована',
        archiveMachine: 'Архивировать машину',
        archiveMachineConfirm: 'Архивировать эту машину? Она исчезнет из обычных селекторов, пока вы её не восстановите.',
        archiveMachineHelp: 'Скрывает машину из обычных сценариев запуска без удаления записи.',
        archiveMachineSuccess: 'Машина архивирована.',
        archiveMachineFailed: 'Не удалось архивировать машину.',
        restoreMachine: 'Восстановить машину',
        restoreMachineConfirm: 'Вернуть эту архивированную машину в рабочее пространство?',
        restoreMachineHelp: 'Снова делает машину доступной в лаунчерах.',
        restoreMachineSuccess: 'Машина восстановлена.',
        restoreMachineFailed: 'Не удалось восстановить машину.',
        deleteMachine: 'Удалить машину',
        deleteMachineConfirm: 'Удалить эту машину навсегда? Это удалит сохранённую запись из вашей учётной записи.',
        deleteMachineHelp: 'Навсегда удалить эту offline-запись машины.',
        deleteMachineDisabledActive: 'Остановите daemon или дождитесь, пока эта машина перейдёт в офлайн, перед удалением.',
        deleteMachineSuccess: 'Машина удалена.',
        deleteMachineFailed: 'Не удалось удалить машину.',
        archiveMachineDisabledActive: 'Остановите daemon или дождитесь, пока эта машина перейдёт в офлайн, перед архивированием.',
        renameMachine: 'Переименовать машину',
        renamePrompt: 'Задайте этой машине своё имя. Оставьте пустым, чтобы использовать стандартный hostname.',
        renamePlaceholder: 'Введите имя машины',
        renameSuccess: 'Машина успешно переименована.',
        renameFailed: 'Не удалось переименовать машину.',
        customPathPlaceholder: 'Введите собственный путь',
        createDirectoryTitle: 'Создать каталог?',
        createDirectoryConfirm: ({ directory }: { directory: string }) => `Каталог '${directory}' не существует. Создать его?`,
        startSessionFailed: 'Не удалось запустить сессию. Убедитесь, что daemon всё ещё работает на целевой машине.',
    ...
    agents: {
        ...
        newCorps: 'Новый отряд',
        buildCorpsTitle: 'Создать отряд',
        buildCorpsAddRole: 'Добавить роль',
        buildCorpsEmptyHint: 'Добавьте роли для формирования отряда',
        buildCorpsStart: 'Запустить отряд',
